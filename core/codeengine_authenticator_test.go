...
const (
	...
	codeEngineAuthTestLogLevel       LogLevel = LevelError
	codeEngineAuthMockCRTokenFile    string   = "../resources/cr-token.txt"       // #nosec
	codeEngineAuthEmptyCRTokenFile   string   = "../resources/empty-cr-token.txt" // #nosec
	codeEngineAuthMockIAMProfileName string   = "iam-user-123"
	codeEngineAuthMockIAMProfileID   string   = "iam-id-123"
	codeEngineAuthMockClientID       string   = "client-id-1"
	codeEngineAuthMockClientSecret   string   = "client-secret-1"
	codeEngineAuthTestCRToken1       string   = "cr-token-1"

	codeEngineAuthTestAccessToken1 string = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..cIodB4I6CCcX8vfIImz7Cytux3GpWyObt9Gkur5g1QI"       // #nosec
	codeEngineAuthTestAccessToken2 string = "3yJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..cIodB4I6CCcX8vfIImz7Cytux3GpWyObt9Gkur5g1QI"       // #nosec
	codeEngineAuthTestRefreshToken string = "Xj7Gle500MachEOiJKV1QiLCJhbGciOiJIUzI1NiJ9..cIodB4I6CCcX8vfIImz7Cytux3GpWyObt9Gkur5g1QI" // #nosec
)

func TestCodeEngineAuthCtorErrors(t *testing.T) {
	var err error
	var auth *CodeEngineAuthenticator

	// Error: missing IAMProfileName and IBMProfileID.
	auth, err = NewCodeEngineAuthenticatorBuilder().Build()
	assert.NotNil(t, err)
	assert.Nil(t, auth)
	t.Logf("Expected error: %s", err.Error())

	// Error: missing ClientID.
	auth, err = NewCodeEngineAuthenticatorBuilder().
		SetIAMProfileName(codeEngineAuthMockIAMProfileName).
		SetClientIDSecret("", codeEngineAuthMockClientSecret).
		SetClient(nil).
		Build()
	assert.NotNil(t, err)
	assert.Nil(t, auth)
...
func TestCodeEngineAuthCtorSuccess(t *testing.T) {
	var err error
	var auth *CodeEngineAuthenticator
...
func TestCodeEngineAuthCtorFromMapErrors(t *testing.T) {
	var err error
	var auth *CodeEngineAuthenticator
	var configProps map[string]string

	// Error: nil config map
	auth, err = newCodeEngineAuthenticatorFromMap(configProps)
	assert.NotNil(t, err)
	assert.Nil(t, auth)
	t.Logf("Expected error: %s", err.Error())
...
func TestCodeEngineAuthCtorFromMapSuccess(t *testing.T) {
	var err error
	var auth *CodeEngineAuthenticator
	var configProps map[string]string
...
func TestCodeEngineAuthDefaultURL(t *testing.T) {
...
func TestCodeEngineAuthRetrieveCRTokenSuccess(t *testing.T) {
...
func TestCodeEngineAuthRetrieveCRTokenFail(t *testing.T) {
	GetLogger().SetLogLevel(containerAuthTestLogLevel)
...
func TestCodeEngineAuthGetTokenSuccess(t *testing.T) {
	GetLogger().SetLogLevel(containerAuthTestLogLevel)
...
func TestCodeEngineAuthGetTokenSuccess10SecWindow(t *testing.T) {
	GetLogger().SetLogLevel(containerAuthTestLogLevel)
...
func TestCodeEngineAuthRequestTokenSuccess(t *testing.T) {
	GetLogger().SetLogLevel(containerAuthTestLogLevel)
...
func TestCodeEngineAuthRequestTokenError1(t *testing.T) {
	GetLogger().SetLogLevel(containerAuthTestLogLevel)
...
func TestCodeEngineAuthRequestTokenError2(t *testing.T) {
	GetLogger().SetLogLevel(containerAuthTestLogLevel)
...
func TestCodeEngineAuthAuthenticateSuccess(t *testing.T) {
	GetLogger().SetLogLevel(containerAuthTestLogLevel)
...
func TestCodeEngineAuthAuthenticateFailNoCRToken(t *testing.T) {
	GetLogger().SetLogLevel(containerAuthTestLogLevel)
...
func TestCodeEngineAuthAuthenticateFailIAM(t *testing.T) {
	GetLogger().SetLogLevel(containerAuthTestLogLevel)
...
func TestCodeEngineAuthBackgroundTokenRefreshSuccess(t *testing.T) {
	GetLogger().SetLogLevel(containerAuthTestLogLevel)
...
func TestCodeEngineAuthBackgroundTokenRefreshFail(t *testing.T) {
	GetLogger().SetLogLevel(containerAuthTestLogLevel)
...
func TestCodeEngineAuthClientIdAndSecret(t *testing.T) {
	GetLogger().SetLogLevel(containerAuthTestLogLevel)
...
func TestCodeEngineAuthDisableSSL(t *testing.T) {
	GetLogger().SetLogLevel(containerAuthTestLogLevel)
...
func TestCodeEngineAuthUserHeaders(t *testing.T) {
	GetLogger().SetLogLevel(containerAuthTestLogLevel)
...
func TestCodeEngineAuthGetTokenTimeout(t *testing.T) {
	GetLogger().SetLogLevel(containerAuthTestLogLevel)
